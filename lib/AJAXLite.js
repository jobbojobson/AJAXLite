...
export class AJAXLite {
	...
	*/
	send( url, opt ){
		...
		if(!url) throw 'AJAXLite: send() invalid parameters';
		...
		//GET, or DELETE: parameter to send() is null, url holds the answers..
	...
	*/
	...
	/*
	*	A wrapper around get() that sets the content type to JSON
	*/
	...
	/*
	*	A wrapper around post() that sets the content type to JSON
	*/
